...
(function() {
  ...
  ContentTools.Tools.Link = (function() {
    class Link extends ContentTools.Tools.Bold {
    ...
    ContentTools.ToolShelf.stow(Link, 'restrictedLink');
  ...
  ContentTools.RestrictedLinkDialog = (function() {
